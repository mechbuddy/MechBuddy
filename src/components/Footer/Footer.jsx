            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <ul className=" flex gap-4 mb-8">
                <li>
                  ...
                  <svg
                    className="h-6 w-6 text-white cursor cursor-pointer"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
                ...
                <li>
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    onClick={() => { window.location.href = "https://www.instagram.com/mechbuddy_?igshid=NmE0MzVhZDY%3D" }}
                ...
                <li className="flex items-center">
                  ...
                  <svg
                    ...
                    version="1.0"
                    className="h-4 w-4 text-white cursor cursor-pointer"
                    viewBox="0 0 2400.000000 2453.000000"
                    preserveAspectRatio="xMidYMid meet"
                    onClick={() => { window.location.href = "https://twitter.com/mechbuddy_?t=bTG9sdbxzkI3cNe_HBteOg&s=09" }}
                  >
                    <metadata>
                ...
                <li>
                  ...
                  <svg className="w-5 h-5 text-white cursor cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15" onClick={() => { window.location.href = "https://www.linkedin.com/company/mech-buddy-com/" }}>
                ...
                <li>
                  ...
                  <svg className="w-6 h-6 text-white cursor cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 14"
                  onClick={()=>{window.location.href = "https://www.youtube.com/@mechbuddy_"}}>
