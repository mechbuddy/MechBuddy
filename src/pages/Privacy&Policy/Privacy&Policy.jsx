...
Opt-out      of receiving marketing communications from us by following the unsubscribe instructions provided in the communication or by contacting us directly.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Changes to the Privacy Policy</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>We may update this Privacy Policy periodically to reflect changes in our practices or legal requirements. We encourage you to review this Policy regularly for updates. Your continued use of our services after the changes constitute your acceptance of the revised Policy.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Contact Us</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact our Privacy Team at privacysibeyindia@gmail.com</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Service Booking and Third-Party Contractors</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>When you book a service through MechBuddy, we connect you with the nearest partner mechanic from our trusted network. These mechanics are independent third-party contractors, not employees of MechBuddy. You have the option to select a mechanic from the list provided on our platform.</p>
        ...
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>While we strive to ensure the availability of services requested, unforeseen circumstances such as traffic jams or road diversions may impact service availability. The prices displayed on our platform are estimates for major repairs and may vary based on actual service requirements.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Subscription and On-the-Spot Services</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>Subscription services are available for individual vehicles only. While some services are available on-the-spot, immediate resolution may not always be possible in case of breakdowns or complex repairs.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Payment for Replacement Parts</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>Charges for replacement parts, oils, coolants, etc., will be based on actual costs incurred during the service. Detailed invoices will be provided upon request.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Conditions for Service Provision</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>We reserve the right to refuse service to anyone under the influence of alcohol, drugs, or exhibiting suspicious behavior. Non-payment of service charges or misuse of our services may result in necessary legal actions.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Accuracy of Information</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>Customers are responsible for providing accurate information while availing services. MechBuddy is not liable for any issues arising from false or inaccurate information provided by the customer.</p>
...
<h3 className="mt-[4vw] mb-[1.3vw] text-bold text-xl  font-normal font-[sofia-light] sm:text-2xl">Towing and Recovery Services</h3>
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>In case of major repairs or breakdowns, vehicles will be towed using appropriate methods such as flatbed towing or lifting towing, depending on the vehicle's condition. Additional charges may apply for specialized recovery services.</p>
        ...
        <p style={{
            ...
            wordSpacing:"3px",
            letterSpacing:"1px"
          }}>Customers are prohibited from demanding additional services or benefits in exchange for false reviews. MechBuddy reserves the right to modify or update these terms and conditions without prior notice. Customers are advised to review our terms and conditions before availing any services.</p>
        ...
        <p style={{
            ...
            color: "#5E5E5E",
            marginBottom:"100px"
          }}>While we provide vehicle modification services based on your requirements, MechBuddy is not responsible for any legal actions or consequences arising from vehicle modifications. Customers are advised to comply with local regulations and laws when modifying their vehicles</p>
      </div>
      <Footer/>
    </div>
  );
