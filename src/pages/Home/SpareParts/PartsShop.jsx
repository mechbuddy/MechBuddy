  ...
  return (
    <div className='w-[35vw] md:w-[17vw] h-[40vh] md:h-[48vh] flex flex-col items-center justify-start bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-sm mb-[5vh]'>
        ...
        <div className='mb-[1.3vh]'>
            <Link to={"/product/:productId"}><div className='w-[30vw] md:w-[15vw] h-[20vh] md:h-[30vh] bg-gradient-to-b from-red-100 via-red-200 to-red-300 flex justify-center items-center'>
        ...
        <button className='w-[30vw] md:w-[15vw] text-[white] bg-[#F31D32] rounded p-[0.5vh]'  >Add To Cart</button>
    </div>
  )
}
